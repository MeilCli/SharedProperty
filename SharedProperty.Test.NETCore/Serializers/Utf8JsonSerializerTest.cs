...
{
    [TestClass]
    public class Utf8JsonSerializerTest
    {
        [TestCategory(TestCategoryConstant.Serializee)]
        [TestMethod]
        public void ShortModeSerialize()
        {
            var sharedDictionary = new SharedDictionary(new Utf8JsonSerializer(SerializeMode.ShortObject), null, null);
        ...
        {
            var sharedDictionary = new SharedDictionary(new Utf8JsonSerializer(SerializeMode.LargeObject), null, null);
